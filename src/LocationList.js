...
class LocationList extends Component {
  ...
  render() {
    ...
    return (<div className="search">
      <input role="search" aria-label="filter" id="search-field" className="search-field" type="text" placeholder="Filtre" value={this.state.query} onChange={this.filterLocations}/>
      <ul>
